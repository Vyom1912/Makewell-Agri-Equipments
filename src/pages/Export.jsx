...
const REGIONS = [
  { num: '01', name: 'Africa',                 countries: 'Nigeria · Ghana · Kenya · Tanzania · Mozambique · Ethiopia · South Africa · Uganda' },
  { num: '02', name: 'Middle East',            countries: 'UAE · Saudi Arabia · Oman · Yemen · Jordan · Kuwait · Qatar · Bahrain' },
  { num: '03', name: 'South & Southeast Asia', countries: 'Bangladesh · Sri Lanka · Nepal · Myanmar · Philippines · Pakistan · Cambodia' },
  { num: '04', name: 'Europe & Americas',      countries: 'United Kingdom · Germany · Netherlands · USA · Canada · France · Belgium' },
];
...
const PROCESS_STEPS = [
  {
    ...
    specs: ['24–48 hr response', 'Product spec included', 'No commitment required'],
  },
  {
    num: '02', icon: '📝',
    title: 'Order Confirmation',
    desc: 'Purchase order raised, advance payment or L/C arranged. Production slot confirmed in our schedule.',
    specs: ['L/C or T/T accepted', 'Slot confirmed in writing', 'Flexible lead times'],
  },
  {
    num: '03', icon: '⚒️',
    title: 'Production',
  ...
  },
  {
    ...
    specs: ['Shipment tracking', 'Post-delivery support', 'Easy reorder process'],
  },
];

const LOGISTICS = [
  { icon: '🏭', title: 'Manufacturing Hub',   body: 'Himatnagar, Sabarkantha — India\'s most prominent agricultural hand tool cluster with a century-old forging tradition.' },
  { icon: '🛣️', title: 'Road Connectivity',   body: 'Direct NH-48 highway access. Ahmedabad 90 km — connecting to the national road network and all major ports.' },
  { icon: '🚢', title: 'Port Access',          body: 'Mundra Port ~220 km · Kandla Port ~250 km — two of India\'s largest cargo ports on global shipping lanes.' },
  { icon: '✈️', title: 'Air Freight',          body: 'Ahmedabad International Airport 90 km — for express samples or urgent smaller consignments worldwide.' },
];
    ...
    <>
      ...
      <section className="section" ref={reachRef}>
        <div className="container">
          <div className="sec-head sec-head--row reveal">
            <div>
              <div className="eyebrow"><span className="idx">Global Reach</span><span className="rule" /></div>
              <h2>50+ countries.<br />Four continents.</h2>
            </div>
            <p className="sec-sub">Makewell tools reach farmers, contractors and distributors worldwide. Our export infrastructure handles everything from documentation to last-mile delivery.</p>
          </div>
      ...
      <section className="section section-alt" ref={processRef}>
        <div className="container">
          <div className="sec-head sec-head--row reveal">
            <div>
              <div className="eyebrow"><span className="idx">Export Process</span><span className="rule" /></div>
              <h2>From inquiry<br />to delivery.</h2>
            </div>
            <p className="sec-sub">A clear, step-by-step process so you know exactly what to expect at every stage — from your first message to the goods arriving at your warehouse.</p>
          </div>
              ...
              <div className="item-row" key={step.num}>
                ...
                <div className="info">
                  ...
                  <ul className="specs-list">
                    {step.specs.map((sp) => <li className="tag-chip" key={sp}>{sp}</li>)}
                  </ul>
                </div>
              </div>
            ))}
      ...
      <section className="section section-dark" ref={logisticRef}>
        <div className="container">
          <div className="sec-head sec-head--row reveal">
            <div>
              <div className="eyebrow"><span className="idx">Logistics</span><span className="rule" /></div>
              <h2>Placed for global shipping.</h2>
            </div>
            <p className="sec-sub">Himatnagar's location gives direct access to India's two largest cargo ports and the main highway network — keeping lead times short and costs predictable.</p>
          </div>
