        ...
        <div className='footer-grid'>
          ...
          <div className='footer-brand'>
            <Link to='/' className='f-logo'>
              ...
              <span className='brand-text'>
                <span className='name footer-name'>Makewell</span>
                <br />
                <span className='tag'>Agri Equipments</span>
              </span>
            </Link>
            <p>
              Premium agricultural hand tools — forged in Gujarat, trusted by
              dealers and farmers worldwide.
            </p>
          ...
          <div className='footer-col'>
            ...
            <ul className='fc-contact'>
              ...
              <li>
                🕐 Mon, Wed–Sun: 9 am – 6 pm IST
                <br />
                <span style={{ opacity: 0.65 }}>Tuesday: Closed</span>
              </li>
            </ul>
          </div>
        </div>
